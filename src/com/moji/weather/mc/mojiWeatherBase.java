...
public class mojiWeatherBase {
	...
	public void login() throws InterruptedException {
		...
		//driver.findElementByAndroidUIAutomator("new UiSelector().text(\"皮肤小铺\")").click();
	...
	public void test() throws InterruptedException{
		...
		List<WebElement> btn2 = driver.findElementsByClassName("android.widget.ImageView");
		btn2.get(1).click();
	}
	
	public void Back() throws InterruptedException {
		// 返回按钮
		driver.findElement(By.id("com.moji.mjweather:id/temp_hundred")).click();
		List<WebElement> btn1 = driver.findElementsByClassName("android.widget.ImageView");
		btn1.get(1).click();
		System.out.println("点击返回");

		// 墨迹资讯与语音播报下方入口id一样，需要区分
		// 墨迹资讯
		driver.findElement(By.id("com.moji.mjweather:id/gf_icon")).click();
		List<WebElement> btn2 = driver.findElementsByClassName("android.widget.ImageView");
		btn1.get(1).click();

		// 短时页面
		driver.findElement(By.id("com.moji.mjweather:id/short_time_entry_norain")).click();
		List<WebElement> btn4 = driver.findElementsByClassName("android.widget.ImageView");
		btn1.get(2).click();

		// 反馈天气页面
		driver.findElement(By.id("com.moji.mjweather:id/btn_report")).click();
		List<WebElement> btn5 = driver.findElementsByClassName("android.widget.ImageView");
		btn1.get(2).click();
		/*
		 * //语音播报下方入口 List<WebElement> btnvoice =
		 * driver.findElementsByClassName("android.widget.ImageView");
		 * btnvoice.get(15).click();
		 * 
		 * 
		 * List<WebElement> btn3 =
		 * driver.findElementsByClassName("android.widget.ImageView");
		 * btn1.get(1).click();
		 */
